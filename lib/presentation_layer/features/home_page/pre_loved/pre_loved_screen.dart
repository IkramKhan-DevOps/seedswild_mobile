...
import 'package:annafi_app/presentation_layer/features/home_page/widgets/single_product_view.dart';
import 'package:annafi_app/utils/components/custom_search_view.dart';
import 'package:flutter/material.dart';

class PreLovedScreen extends StatefulWidget {
  const PreLovedScreen({super.key});

  @override
  State<PreLovedScreen> createState() => _PreLovedScreenState();
}
...
class _PreLovedScreenState extends State<PreLovedScreen> {
  ...
  onTapProductDetailedView(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.preLoveProductView);
  }
