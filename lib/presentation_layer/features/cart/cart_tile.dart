      ...
      builder: (context, cartProvider, child) {
        return Row(
          ...
          children: [
            // IMAGE
            CustomImageView(
              url: cartProvider.cart[index].image ?? "https://placehold.co/200/png",
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "${cartProvider.cart[index].price * cartProvider.cart[index].quantity}",
                    style: TextStyle(
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        child:
                        Text(cartProvider.cart[index].quantity.toString(), style: TextStyle(fontSize: 18)),
                      ),
                      InkWell(
                        onTap: () {
